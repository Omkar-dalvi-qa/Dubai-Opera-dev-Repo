...
/**
 * Same-origin proxy for `POST /external/cashcard/remove-gift-card`.
 */
export async function POST(req: NextRequest) {
  ...
  const result = await eventService.post<RemoveGiftCardResponse>("/external/cashcard/remove-gift-card", {
    body,
  });
